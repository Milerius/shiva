...
{
    shiva::fs::copy("systems", "save", shiva::fs::copy_options::recursive | shiva::fs::copy_options::overwrite_existing);
    shiva::fs::remove_all("systems");
    ASSERT_FALSE(system_manager_.load_plugins());
    shiva::fs::copy("save", "systems", shiva::fs::copy_options::recursive | shiva::fs::copy_options::overwrite_existing);
